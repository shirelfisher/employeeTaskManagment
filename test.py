...
def employee_screen():
    ...
    employee_frame.pack(fill='both', expand=True, padx=200, pady=93)

    headline_label = Label(employee_frame, text='Employee Task Management View', font=('david', 18, 'bold'), pady=10,
                           bg='#B4CDCD', fg='white')
    ...
    #
    # vertical_scr = ttk.Scrollbar(upper_frame, orient='vertical')
    #
    ...
    #
    # vertical_scr.pack(side='right', fill='y', padx=2)
    #
    # employee_table.pack(pady=10, anchor='nw', padx=2, fill='both', expand=True)
    #
